...
function FragmentsClient(startFragment, options) {
   ...
   **************************************/
    ...
    var cacheSize = properties.get('sizeCache');
    var cache = this._cache = new Cache({ max: cacheSize });
  ...
  **************************************/
    ...
    if (cache.has(key)) {
        if (typeof(this._log) != 'undefined')
            this._log.incrementNbLocalCalls();
...
FragmentsClient.prototype.setLog = function(log) {
    this._log = log;
}
...
Fragment.prototype.loadFromUrl = function (pageUrl) {
  ...
  /*************************************                                                                                            
      BEGIN INSERTED CODE                                                                                                           
  **************************************/
    if (typeof (this._fragmentsClient._log) != 'undefined')
        this._fragmentsClient._log.incrementNbServerCalls();
    var log = this._fragmentsClient._log;
  /*************************************                                                                                            
      END INSERTED CODE                                                                                                             
  **************************************/
  ...
  page.getProperty('statusCode', function (statusCode) {
    ...
    page.getProperty('contentType', function (contentType) {
      ...
      /*************************************                                                                                        
          BEGIN MODIFIED CODE                                                                                                       
      **************************************/
	var parsedPage = fragment._page = new Parser(page, pageUrl, log);
      /*************************************                                                                                        
          END MODIFIED CODE                                                                                                         
      **************************************/
